...
13. **מחירון** — ישות `Price` הוסרה; המחירים עברו לשדה `knowledge` ב-BotConfig. ברירת המחדל של `DEFAULT_BOTCONFIG["knowledge"]` כבר מכילה ~270 מחירים ששודרגו מאתר driverim.online; הבוט משתמש בהם ישירות מתוך הידע שהוגדר. עדיין אין מנוע שמגלה מחיר אוטומטית שלא ברשימה.
