...
כל נסיעה שמסתיימת מזכה את מספר הטלפון בקרדיטים לפי סכום הנסיעה. לא מוענק קרדיט על נסיעות שלא בוצעו, וניתן לממש קרדיטים לנסיעת חינם (תשלום בקרדיט). מתנה חד-פעמית של קרדיט ראשון מוענקת בנסיעה הראשונה.
...
- IVR: `GET/POST /ivr/passenger` — תפריט אישי (יתרת קרדיטים, מימוש, שתפו וסעו, העדפות).
