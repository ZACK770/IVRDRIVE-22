...
AUDIO_TEXTS: dict[str, str] = {
    ...
    "driver_register": "שלום, אינכם רשומים במערכת. להרשמת נהג חדש הקישו 1.",
    ...
    "driver_pending": "פרטיכם נקלטו במערכת וממתינים לאישור מנהל. תודה ולהתראות.",
    "driver_offer": "נפתחה קריאה חדשה באזורכם. לקבלת פרטי הנסיעה והגשת הצעה הקישו 1.",
