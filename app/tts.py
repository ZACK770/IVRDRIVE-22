...
AUDIO_TEXTS: dict[str, str] = {
    ...
    "terms_intro": (
        "שלום וברוכים הבאים. "
        "אנו שמחים להעניק לכם מענק הצטרפות של {points} נקודות. "
        "בהקשה על 1 הנכם מסכימים לתקנון ההצטרפות ולתנאיו ומקבלים את המענק. "
        "לשמיעת התקנון הקישו 2."
    ),
    "terms_full": (
        "תקנון ההצטרפות. "
        "השירות מופעל כפלטפורמת תיווך בין נוסעים לבין נהגים עצמאיים. "
        "הפלטפורמה מתווכת בין הצדדים בלבד, ואינה מבצעת את הנסיעה, אינה צד לה ואינה לוקחת חלק בביצועה. "
        "הפלטפורמה אינה נושאת באחריות כלשהי לנסיעה, לרכב, להתנהלות הנהג או לכל נזק שייגרם במהלכה. "
        "באחריות הנוסע ובסמכותו לברר כי לנהג שתווך עבורו באמצעות המערכת קיימים כל הרישיונות, "
        "הביטוחים וההסמכות הנדרשים על פי דין, ככל שנדרשים. "
        "התשלום והתנאים מוסכמים בין הנוסע לנהג. "
        "להסכמה לתקנון ולקבלת מענק ההצטרפות הקישו 1."
    ),
    "terms_accepted": "תודה. התקנון אושר ומענק ההצטרפות של {points} נקודות נזקף לזכותכם. יתרתכם היא {balance}.",
    "terms_already": "התקנון כבר אושר בעבר מהמספר הזה. יתרת הנקודות שלכם היא {balance}.",
    "terms_declined": "לא התקבלה הסכמה לתקנון. ניתן לחזור ולהתקשר בכל עת. להתראות.",
